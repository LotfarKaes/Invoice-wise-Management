                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <p>{{ trans('application.invoices_partially_paid') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <p>{{ trans('application.unpaid_invoices') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <p>{{ trans('application.invoices_overdue') }} </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <p>{{ trans('application.paid_invoices') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{!! route('invoices.edit',$invoice->uuid) !!}" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i> {{ trans('application.edit') }} </a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{!! route('estimates.edit',$estimate->uuid) !!}" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i> {{ trans('application.edit') }} </a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
